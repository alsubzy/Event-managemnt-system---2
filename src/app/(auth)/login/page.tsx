...
import { Calendar, Mail, Lock, ArrowRight, Github, Chrome } from 'lucide-react';
          ...
          <div className="bg-white/10 backdrop-blur-xl p-6 rounded-3xl border border-white/10">
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full border-2 border-primary overflow-hidden">
                 <Image src="https://picsum.photos/seed/testimonial/100/100" width={48} height={48} alt="Testimonial" />
              </div>
              <div>
